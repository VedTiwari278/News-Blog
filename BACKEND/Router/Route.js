...
/* ========= POST ROUTES ========= */
router.post("/admin/add-post", authMiddleware, upload.single("image"), controller.addpost);
...
/* ========= PUT ROUTES ========= */
router.put("/admin/update-category/:id", authMiddleware, controller.updateCategory);
...
/* ========= DELETE ROUTES ========= */
router.delete("/admin/delete-category/:id", authMiddleware, controller.deleteCategory);
